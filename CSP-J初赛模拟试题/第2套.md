...
05 while(cin>>n&&n!=0){
     ...
     int tj min=0,tj max=n-l;
     int king_min=0,king_max=n-l;
...
02 int mymax=10000;
03 int E[4][2]-{{-1,0},{1,0},(0,-1},(0,1}};
09 int a[20][20],v[20][20],v1[20][20];05
   int l=1;
06  int n;//矩阵的规模
08 bool check(int xl,int yl){
   i£(x1<0||x1>=n||)return false;
...
(5)⑧处和⑨处填()。
A. qn[i][1]和 qn[i][2]  B.qn[i][0]和 qn[i][1] C. qn[1][i]和 qn[2][i] D.qn[0][i]和 qn[1][i]
